//utils me vo code hai jo code baar baar likhna padta hai par usko ek bbar lik ke use kar rahe
...
class SecurityUtils {
    ...
    //That means you don't create an object.
    //You directly use: SecurityUtils.validatePassword("Adarsh@123") instead of: const security = new SecurityUtils(); security.validatePassword(...);
